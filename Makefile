BIN_FILES=dumpview  mips-configure svn-list-commits svn-merge-list svn-merge-message svn-merge-revs svn-merge-info tn update-group-cfg zgetfile zmk ztelnet zupload mklinks zping getdump perflog
